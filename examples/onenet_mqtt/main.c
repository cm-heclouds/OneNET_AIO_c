...
int main(int arg, char *argv[])
{
    ...
    mqtt_config.product_id = CN_PRODUCT_ID_MQTT;
    mqtt_config.device_sn  = CN_DEVICE_ID_MQTT;
    mqtt_config.auth_code  = CN_DEVICE_KEY_MQTT;
    ...
    if(iot_dev_ptr != NULL)
    {
        ...
        iot_dev_observe(iot_dev_ptr, "test_observe_data", 1000);
    }
    else
    {
