...
static int32_t set_value_with_timestamp(cJSON *data, const uint8_t *name, cJSON *value, int64_t ts_in_ms)
{
    cJSON *sub    = NULL;
...
static int32_t set_value(cJSON *data, const uint8_t *name, cJSON *value)
{
    if (cJSON_IsArray(data))
    {
        if (value)
...
int32_t tm_onejson_pack_bool_with_timestamp(void *data, const uint8_t *name, boolean val, int64_t ts_in_ms)
{
    return set_value_with_timestamp((cJSON *)data, name, cJSON_CreateBool(val), ts_in_ms);
}

int32_t tm_onejson_pack_number_with_timestamp(void *data, const uint8_t *name, float64_t val, int64_t ts_in_ms)
{
    return set_value_with_timestamp((cJSON *)data, name, cJSON_CreateNumber(val), ts_in_ms);
}

int32_t tm_onejson_pack_float32_with_timestamp(void *data, const uint8_t *name, float32_t val, int64_t ts_in_ms)
{
    return set_value_with_timestamp((cJSON *)data, name, cJSON_CreateNumber(float32_to_float64(val)), ts_in_ms);
}

int32_t tm_onejson_pack_string_with_timestamp(void *data, const uint8_t *name, uint8_t *val, int64_t ts_in_ms)
{
    return set_value_with_timestamp((cJSON *)data, name, cJSON_CreateString((const char *)val), ts_in_ms);
}

int32_t tm_onejson_pack_struct_with_timestamp(void *data, const uint8_t *name, void *val, int64_t ts_in_ms)
{
    return set_value_with_timestamp((cJSON *)data, name, (cJSON *)val, ts_in_ms);
}

int32_t tm_onejson_pack_bool(void *data, const uint8_t *name, boolean val)
{
    return set_value((cJSON *)data, name, cJSON_CreateBool(val));
}
int32_t tm_onejson_pack_number(void *data, const uint8_t *name, float64_t val)
{
    return set_value((cJSON *)data, name, cJSON_CreateNumber(val));
}

int32_t tm_onejson_pack_float32(void *data, const uint8_t *name, float32_t val)
{
    return set_value((cJSON *)data, name, cJSON_CreateNumber(float32_to_float64(val)));
}

int32_t tm_onejson_pack_string(void *data, const uint8_t *name, uint8_t *val)
{
    return set_value((cJSON *)data, name, cJSON_CreateString((const char *)val));
}

int32_t tm_onejson_pack_struct(void *data, const uint8_t *name, void *val)
{
...
void *tm_onejson_get_data_by_name(void *data, const uint8_t *name)
{
...
int32_t tm_onejson_parse_string(void *data, uint8_t **val)
{
    cJSON *obj = (cJSON *)data;
...
uint32_t tm_onejson_pack_request(uint8_t *payload, int32_t msg_id, void *params, uint8_t as_raw)
{
    ...
    cJSON_AddStringToObject(request, "version", CONFIG_TM_VERSION);
    if (params)
    {
        if (as_raw)
        {
    ...
    if (NULL != (temp_str = (uint8_t *)cJSON_PrintUnformatted(request)))
    {
...
void *tm_onejson_parse_reply(uint8_t *payload, uint32_t payload_len, uint8_t *msg_id, int32_t *msg_code, uint8_t as_raw)
{
    cJSON *root = NULL;
    cJSON *item = NULL;
    void * data = NULL;
