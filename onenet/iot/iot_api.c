...
struct iot_dev_t
{
    ...
    int32_t (*push)(void *, const int8_t *, void *, uint32_t, uint32_t);
    int32_t (*notify)(void *, struct iot_data_t *, uint32_t);
    int32_t (*close)(void *, uint32_t);
    int32_t (*observe)(void *, const int8_t *, uint32_t);
    int32_t (*observe_cancel)(void *, const int8_t *, uint32_t);
};
...
int32_t iot_dev_push_rawdata(void *dev, const int8_t *resource, void *raw_data, uint32_t data_len, uint32_t timeout_ms)
{
    struct iot_dev_t *iot_dev = (struct iot_dev_t *)dev;
...
int32_t iot_dev_observe(void *dev, const int8_t *resource, uint32_t timeout_ms)
{
    struct iot_dev_t *iot_dev = (struct iot_dev_t *)dev;
