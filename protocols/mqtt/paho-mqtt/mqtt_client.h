...
typedef void (*messageHandler)(void *, const uint8_t *, struct mqtt_message_t *);
 ...
 *  @return success code
 */
int32_t mqtt_client_set_message_handler(void *client, const char *topicFilter, messageHandler messageHandler,
                                        void *arg);
